...
resource "aws_route" "public_igw_route" {
  ...
  route_table_id         = flatten([module.public_subnet.route_table_ids])[count.index]
...
resource "aws_route" "private_nat_route" {
  ...
  route_table_id         = flatten([module.private_subnet.route_table_ids])[count.index]
...
# Therefore we need a way to depend on the NAT Gateway in Terraform and wait until it is finished.
