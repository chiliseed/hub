...
output "master_parameter_group_id" {
  ...
  value       = module.master.this_db_parameter_group_id
}

output "master_parameter_group_arn" {
  description = "The ARN of the db parameter group"
  value       = module.master.this_db_parameter_group_arn
}

output "master_option_group_id" {
  description = "The db option group id"
  value       = module.master.this_db_option_group_id
}

output "master_option_group_arn" {
  description = "The ARN of the db option group"
  value       = module.master.this_db_option_group_arn
}
...
output "read_instance_address" {
  description = "The address of the RDS instance"
  value       = module.read-replica.this_db_instance_address
}

output "read_instance_arn" {
  description = "The ARN of the RDS instance"
  value       = module.read-replica.this_db_instance_arn
}

output "read_instance_availability_zone" {
  description = "The availability zone of the RDS instance"
  value       = module.read-replica.this_db_instance_availability_zone
}

output "read_instance_endpoint" {
  description = "The connection endpoint"
  value       = module.read-replica.this_db_instance_endpoint
}

output "read_instance_hosted_zone_id" {
  description = "The canonical hosted zone ID of the DB instance (to be used in a Route 53 Alias record)"
  value       = module.read-replica.this_db_instance_hosted_zone_id
}

output "read_instance_id" {
  description = "The RDS instance ID"
  value       = module.read-replica.this_db_instance_id
}

output "read_instance_resource_id" {
  description = "The RDS Resource ID of this instance"
  value       = module.read-replica.this_db_instance_resource_id
}

output "read_instance_status" {
  description = "The RDS instance status"
  value       = module.read-replica.this_db_instance_status
}

output "read_instance_name" {
  description = "The database name"
  value       = module.read-replica.this_db_instance_name
}

output "read_instance_username" {
  description = "The read username for the database"
  value       = module.read-replica.this_db_instance_username
}
...
output "read_instance_port" {
  description = "The database port"
  value       = module.read-replica.this_db_instance_port
}

output "read_subnet_group_id" {
  description = "The db subnet group name"
  value       = module.read-replica.this_db_subnet_group_id
}

output "read_subnet_group_arn" {
  description = "The ARN of the db subnet group"
  value       = module.read-replica.this_db_subnet_group_arn
}

output "read_parameter_group_id" {
  description = "The db parameter group id"
  value       = module.read-replica.this_db_parameter_group_id
}

output "read_parameter_group_arn" {
  description = "The ARN of the db parameter group"
  value       = module.read-replica.this_db_parameter_group_arn
}

output "read_option_group_id" {
  description = "The db option group id"
  value       = module.read-replica.this_db_option_group_id
}

output "read_option_group_arn" {
  description = "The ARN of the db option group"
  value       = module.read-replica.this_db_option_group_arn
}
